...
function Login(_ref) {
  ...
  }, "Prijavi se"), msg && React.createElement("pre", {
    style: {
      background: 'salmon',
      padding: 10
    }
...
function Logout(_ref) {
  ...
  return React.createElement(React.Fragment, null, React.createElement("div", {
    ...
    className: "RNIW_btn RNIW_btnHeader active odjava"
  }, "Prijavljeni")), React.createElement("form", {
    className: "form "
  }, React.createElement("p", {
    className: "RNIW_infoText"
  }, "Prijavljeni ste kao ", React.createElement("br", null), React.createElement("span", {
    className: "RNIW_infoTextEmail"
  }, name)), React.createElement("button", {
    type: "submit",
    className: isLoading ? 'RNIW_btn RNIW_saving' : 'RNIW_btn',
    onClick: logout
  }, "Odjavi se"), msg && React.createElement("pre", {
    style: {
      background: 'salmon',
      padding: 10
    }
...
function Signup(_ref) {
  ...
  return React.createElement("form", {
    ...
    type: "submit",
    className: isLoading ? 'RNIW_btn RNIW_saving' : 'RNIW_btn'
  }, "Registriraj se"), msg && React.createElement("pre", {
    style: {
      background: 'salmon',
      padding: 10
    }
...
function LoggedOutScreen(props) {
  ...
  }, "Prijava"), React.createElement(Tab, {
    className: "RNIW_btn RNIW_btnHeader"
  }, "Registracija")), React.createElement(TabPanels, null, React.createElement(TabPanel, null, React.createElement(Login, {
